...
try:
    ...
    clf_transaction = joblib.load(os.path.join(models_path, "model_category.joblib"))
    clf_type_transaction = joblib.load(os.path.join(models_path, "model_category.joblib"))
